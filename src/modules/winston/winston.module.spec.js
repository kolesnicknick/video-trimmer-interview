...
var winston_module_1 = require("./winston.module");
describe("Winston Module", function () {
    it("boots successfully", function () { return __awaiter(void 0, void 0, void 0, function () {
        var rootModule;
    ...
    it("boots successfully asynchronously", function () { return __awaiter(void 0, void 0, void 0, function () {
        var ConfigService, FeatureModule, rootModule, app;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, testing_1.Test.createTestingModule({
                            imports: [
                                winston_module_1.WinstonModule.forRootAsync({
                                    ...
                                    useFactory: function (cfg) { return cfg.loggerOptions; },
